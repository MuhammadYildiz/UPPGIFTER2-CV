...
let number = 0;
  ...
  nextProject.addEventListener('click',()=>{
    ...
    projectlink.innerHTML  =`Click on the link to access the project on github repository: <a href = '${dataMain[number].projectURL}' target="_blank">${dataMain[number].projectNmne }</a> `
  })
